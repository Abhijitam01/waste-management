      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className={`absolute ${positions[position]} z-50 px-3 py-2 text-sm text-white bg-slate-800 border border-slate-700 rounded-lg shadow-lg whitespace-nowrap pointer-events-none`}
          >
            {content}
